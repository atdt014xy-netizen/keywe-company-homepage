...
export const precautionItems: PrecautionItem[] = [
  ...
  },
  {
    ...
    status: "ready",
    body: [
      "이자율 연 20% 이내(연체이자율 연 20% 이내). 단, 2021년 7월 7일부터 체결·갱신·연장되는 계약에 한합니다.",
      "대출 예시: 100만원을 12개월간 최대금리 연 20%로 원리금균등상환 방법으로 이용하는 경우 총 상환금액은 1,111,614원입니다. 실제 금액은 대출상품 및 상환방법 등 계약 조건에 따라 달라질 수 있습니다.",
    ],
  },
  {
    id: "early-repayment",
    ...
    status: "ready",
    body: [
      "중도상환수수료 없음 · 취급수수료 없음 · 중개수수료 없음. 상환기간은 12~60개월입니다.",
    ],
  },
  {
    id: "privacy",
  ...
  },
  {
    ...
    status: "ready",
    body: [
      "중개수수료를 요구하거나 받는 것은 불법입니다. Key We 대부중개는 고객님께 중개의 대가로 어떠한 수수료나 사례금도 요구하지 않습니다. 상담 및 중개 과정에서 금전을 요구받으신 경우 즉시 당사로 연락해 주세요.",
    ],
  },
  {
    id: "debt-warning",
