 ...
 * 아래 배열에 입력하세요. 비어 있는 동안 이 블록은 화면에 렌더링되지
 * 않습니다.
 */
...
export const precautionItems: PrecautionItem[] = [
  ...
  },
  {
    ...
    status: "ready",
    body: [
      "대출금리는 연 20% 이내, 연체이자율은 연 20% 이내입니다. 단, 2021년 7월 7일부터 체결·갱신·연장되는 계약에 한합니다.",
      "저희는 여러 제휴 대부업체의 상품을 중개하므로, 상환기간·상환방법·부대비용·중도상환조건은 제휴 대부업체 및 상품별 계약조건에 따라 달라질 수 있습니다. 계약 전 해당 업체를 통해 정확히 안내받으실 수 있습니다.",
    ],
  },
  {
    id: "early-repayment",
    ...
    status: "ready",
    body: [
      "상환기간·상환방법·부대비용·중도상환조건은 제휴 대부업체 및 상품별 계약조건에 따라 달라질 수 있습니다. 계약 체결 전 해당 제휴 대부업체를 통해 정확한 조건을 확인하세요.",
    ],
  },
  {
    id: "privacy",
  ...
  },
  {
    ...
    status: "ready",
    body: [
      "중개수수료를 요구하거나 받는 것은 불법입니다. 키위대부중개는 고객님께 중개의 대가로 어떠한 수수료나 사례금도 요구하지 않습니다. 상담 및 중개 과정에서 금전을 요구받으신 경우 즉시 당사로 연락해 주세요.",
    ],
  },
  {
    id: "debt-warning",
    ...
    body: [
      ...
      "대출 시 신용등급 또는 개인신용평점 하락으로 다른 금융거래가 제약받을 수 있습니다. 상환 능력을 충분히 고려하여 신중하게 결정하시기 바랍니다.",
    ],
  },
];
